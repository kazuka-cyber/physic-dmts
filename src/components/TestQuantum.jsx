...
export default function TestQuantum() {
  ...
  function handleBtn(choice) {
    if (quantum[ind].correct_answer === choice) {
      setScore(score + 1);
      setCorrect([
        ...correct,
        {
          question: quantum[ind].question,
          zuv: quantum[ind].correct_answer,
        },
      ]);
    } else {
      setIncorrect([
